...
export const MOCK_LAWS: Law[] = [
  ...
  {
    id: 'law-us-speeding',
    title: 'Speeding (US Highway)',
    titleHi: 'स्पीडिंग (यूएस हाईवे)',
    summary: 'Exceeding the state speed limits on highways or city streets in the US.',
    summaryHi: 'यूएस में राजमार्गों या शहर की सड़कों पर राज्य की गति सीमा से अधिक होना।',
    officialText: 'VTL Section 1180 — Basic Rule and Maximum Limits. No person shall drive a vehicle at a speed greater than is reasonable and prudent under the conditions and having regard to the actual and potential hazards then existing.',
    simplifiedExplanation: 'Driving faster than the speed limit is penalized with fines ranging from $150 to $600 and points on your driver\'s license depending on the state and speed excess.',
    category: 'speed',
    severity: 'major',
    section: 'VTL §1180',
    act: 'US Code',
    fineRange: '$150 – $600',
    applicableVehicles: ['car', 'commercial', 'heavy'],
    applicableStates: ['US', 'NY', 'CA', 'TX'],
    amendments: [],
    relatedViolationIds: ['speeding'],
    lastUpdated: '2024-02-01',
  },
  {
    id: 'law-gb-speeding',
    title: 'Speeding (UK Road Network)',
    titleHi: 'स्पीडिंग (यूके रोड नेटवर्क)',
    summary: 'Exceeding speed limits in the UK (National Speed Limit or local zones).',
    summaryHi: 'यूके में गति सीमा से अधिक (राष्ट्रीय गति सीमा या स्थानीय क्षेत्र)।',
    officialText: 'Road Traffic Regulation Act 1984 Section 89 — A person who drives a motor vehicle on a road at a speed exceeding a limit imposed by or under any enactment to which this section applies shall be guilty of an offence.',
    simplifiedExplanation: 'The minimum penalty for speeding in the UK is a £100 fine and 3 penalty points added to your license. You may be offered a speed awareness course instead.',
    category: 'speed',
    severity: 'moderate',
    section: 'RTRA §89',
    act: 'RTRA 1984',
    fineRange: '£100 – £2,500',
    applicableVehicles: ['2w', 'car', 'commercial', 'heavy'],
    applicableStates: ['GB', 'ENG', 'SCO', 'WAL'],
    amendments: [],
    relatedViolationIds: ['speeding'],
